...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/loginerror.css')}}">
  ...
  <body>
    ...
    <div class="navbar" style="background-color: #4A503D; height: 60px">
        ...
        <center></center>
        <img src="{{asset('images/logo.png')}}" style="width:1200px; height:1200px;margin-top:-250px;margin-left:150px;position:absolute;opacity:0.3;">
        ...
        <div class="box" align="center" style="position:relative;">
            <div class="content">
                <header>
                    <h2><img src="{{asset('images/user__1__1.png')}}"></h2>
                </header>
                <form method="POST" action="{{url('/login/verify')}}">
                    ...
                    <div class="account" style="letter-spacing: 1px; color:rgb(228, 19, 19);">Username or Password <a>is Incorrect</a></div>
                </form>
            </div>
        </div>
    </center>
